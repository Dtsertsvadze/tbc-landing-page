...
`;
  ...
  const languageSelector = footer.querySelector(".language-selector-footer");
...
const setupFooterExpansion = () => {
  const footer = document.getElementById("footer");
  const mainItems = footer.querySelectorAll(".main-item");
