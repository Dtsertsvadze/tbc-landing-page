const createHeader = () => {
  ...
  header.innerHTML = `
            <div class="header-container">
                ...
                <nav class="main-nav">
                    <ul>
                        <li><a href="#products" class="nav-link" data-content="products">პროდუცტები</a></li>
                        <li><a href="#offers" class="nav-link" data-content="offers">შეთავაზებები</a></li>
                        <li><a href="#concept" class="nav-link" data-content="concept">კონცეპტის სივრცე</a></li>
                    </ul>
                </nav>
